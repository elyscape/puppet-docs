...
[verify_header]: /references/3.7.latest/configuration.html#sslclientverifyheader
[client_header]: /references/3.7.latest/configuration.html#sslclientheader
[ca_auth]: /references/3.7.latest/configuration.html#sslclientcaauth
