...
[verify_header]: /references/3.6.latest/configuration.html#sslclientverifyheader
[client_header]: /references/3.6.latest/configuration.html#sslclientheader
[ca_auth]: /references/3.6.latest/configuration.html#sslclientcaauth
...
Rack web servers must set a client request header, which the puppet master will check based on the [`ssl_client_header` setting](/references/3.6.latest/configuration.html#sslclientheader).
