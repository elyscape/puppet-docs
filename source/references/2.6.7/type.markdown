...
**This page is autogenerated; any changes will get overwritten** *(last generated on Sat Mar 26 08:52:11 +1100 2011)*
...
: The specific backend for provider to use. You will
    ...
    * **urpmi**: Support via `urpmi`.  Required binaries: `urpmi`, `rpm`, `urpmq`.    Default for `operatingsystem` == `mandrivamandrake`.    Supported features: `installable`, `uninstallable`, `upgradeable`, `versionable`.
...
*This page autogenerated on Sat Mar 26 08:52:15 +1100 2011*
