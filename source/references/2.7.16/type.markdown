...
**This page is autogenerated; any changes will get overwritten** *(last generated on Wed Jun 27 11:33:38 -0700 2012)*
...
: The specific backend to use for this `service`
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/initctl`, `/sbin/start`, `/sbin/stop`, `/sbin/restart`, `/sbin/status`.  Default for `operatingsystem` == `ubuntu`.  Supported features: `enableable`, `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `roledel`, `usermod`, `rolemod`, `userdel`, `passwd`, `useradd`, `roleadd`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Wed Jun 27 11:33:39 -0700 2012*
