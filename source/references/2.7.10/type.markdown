...
: The specific backend to use for this `user`
  ...
  : User management for AIX.
    ...
    Required binaries: `/usr/sbin/lsuser`, `/usr/sbin/rmuser`, `/usr/sbin/lsgroup`, `/usr/bin/chuser`, `/bin/chpasswd`, `/usr/bin/mkuser`.  Default for `operatingsystem` == `aix`.  Supported features: `manages_aix_lam`, `manages_expiry`, `manages_homedir`, `manages_password_age`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `roleadd`, `roledel`, `rolemod`, `userdel`, `passwd`, `usermod`, `useradd`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Thu Feb 09 12:29:06 -0800 2012*
