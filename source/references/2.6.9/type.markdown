...
**This page is autogenerated; any changes will get overwritten** *(last generated on Mon Aug 15 12:03:00 -0700 2011)*
...
: The specific backend for provider to use. You will
    ...
    * **mailman**:   Required binaries: `list_lists`, `rmlist`, `newlist`, `/var/lib/mailman/mail/mailman`.
...
: The specific backend for provider to use. You will
    ...
    * **freebsd**: The specific form of package management on FreeBSD.  This is an
        ...
        libraries.  Required binaries: `/usr/sbin/pkg_add`, `/usr/sbin/pkg_delete`, `/usr/sbin/pkg_info`.      Supported features: `installable`, `uninstallable`.
    ...
    * **openbsd**: OpenBSD's form of `pkg_add` support.  Required binaries: `pkg_add`, `pkg_delete`, `pkg_info`.    Default for `operatingsystem` == `openbsd`.    Supported features: `installable`, `uninstallable`, `versionable`.
    ...
    * **sun**: Sun's packaging system.  Requires that you specify the source for
        the packages you're managing.  Required binaries: `/usr/sbin/pkgadd`, `/usr/sbin/pkgrm`, `/usr/bin/pkginfo`.    Default for `operatingsystem` == `solaris`.    Supported features: `installable`, `uninstallable`, `upgradeable`.
...
: The specific backend for provider to use. You will
    ...
    * **user_role_add**: User management inherits `useradd` and adds logic to manage roles on Solaris using roleadd.  Required binaries: `roleadd`, `roledel`, `usermod`, `rolemod`, `userdel`, `passwd`, `useradd`.    Default for `operatingsystem` == `solaris`.    Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Mon Aug 15 12:03:01 -0700 2011*
