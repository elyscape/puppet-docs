...
**This page is autogenerated; any changes will get overwritten** *(last generated on Fri May 18 11:36:52 -0700 2012)*
...
: The specific backend to use for this `user`
  ...
  : User management for AIX.
    ...
    Required binaries: `/usr/bin/chuser`, `/usr/sbin/lsgroup`, `/bin/chpasswd`, `/usr/sbin/lsuser`, `/usr/sbin/rmuser`, `/usr/bin/mkuser`.  Default for `operatingsystem` == `aix`.  Supported features: `manages_aix_lam`, `manages_expiry`, `manages_homedir`, `manages_password_age`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `usermod`, `roleadd`, `userdel`, `passwd`, `roledel`, `useradd`, `rolemod`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Fri May 18 11:36:53 -0700 2012*
