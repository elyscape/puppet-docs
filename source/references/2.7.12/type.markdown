...
**This page is autogenerated; any changes will get overwritten** *(last generated on Tue Mar 27 23:09:45 -0700 2012)*
...
: The specific backend to use for this `package`
  ...
  : Support for FreeBSD's ports.  Note that this, too, mixes packages and ports.
    ...
    Required binaries: `/usr/local/sbin/pkg_deinstall`, `/usr/sbin/pkg_info`, `/usr/local/sbin/portupgrade`, `/usr/local/sbin/portversion`.  Default for `operatingsystem` == `freebsd`.  Supported features: `installable`, `uninstallable`, `upgradeable`.
  ...
  : Support for FreeBSD's ports using the portupgrade ports management software.
    ...
    Required binaries: `/usr/local/sbin/portinstall`, `/usr/local/sbin/pkg_deinstall`, `/usr/sbin/pkg_info`, `/usr/local/sbin/portupgrade`, `/usr/local/sbin/portversion`.  Supported features: `installable`, `uninstallable`, `upgradeable`.
...
: The specific backend to use for this `service`
  ...
  : Support for AIX's System Resource controller.
    ...
    Required binaries: `/usr/bin/refresh`, `/usr/bin/lssrc`, `/usr/bin/stopsrc`, `/usr/bin/startsrc`.  Default for `operatingsystem` == `aix`.  Supported features: `refreshable`.
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/start`, `/sbin/status`, `/sbin/initctl`, `/sbin/stop`, `/sbin/restart`.  Supported features: `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `roleadd`, `roledel`, `rolemod`, `userdel`, `usermod`, `passwd`, `useradd`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Tue Mar 27 23:09:47 -0700 2012*
