...
**This page is autogenerated; any changes will get overwritten** *(last generated on Mon Mar 18 10:58:08 -0700 2013)*
...
: The specific backend to use for this `service`
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/start`, `/sbin/status`, `/sbin/initctl`, `/sbin/restart`, `/sbin/stop`.  Default for `operatingsystem` == `ubuntu`.  Supported features: `enableable`, `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management for AIX.
    ...
    Required binaries: `/usr/sbin/lsgroup`, `/usr/sbin/lsuser`, `/bin/chpasswd`, `/usr/sbin/rmuser`, `/usr/bin/chuser`, `/usr/bin/mkuser`.  Default for `operatingsystem` == `aix`.  Supported features: `manages_aix_lam`, `manages_expiry`, `manages_homedir`, `manages_password_age`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `rolemod`, `userdel`, `roleadd`, `passwd`, `roledel`, `useradd`, `usermod`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
  ...
  : User management via `useradd` and its ilk.  Note that you will need to
    ...
    Required binaries: `userdel`, `chage`, `useradd`, `usermod`.  Supported features: `allows_duplicates`, `manages_expiry`, `manages_homedir`, `system_users`.
...
*This page autogenerated on Mon Mar 18 10:58:08 -0700 2013*
