...
**This page is autogenerated; any changes will get overwritten** *(last generated on Mon Mar 18 10:54:37 -0700 2013)*
...
: The specific backend to use for this `package`
  ...
  : Package management based on Apple's Installer.app and
    ...
    Required binaries: `/usr/bin/hdiutil`, `/usr/sbin/installer`, `/usr/bin/curl`.  Default for `operatingsystem` == `darwin`.  Supported features: `installable`.
...
: The specific backend to use for this `service`
  ...
  : Support for Gentoo's OpenRC initskripts
    ...
    Required binaries: `/sbin/rc-update`, `/sbin/rc-service`, `/bin/rc-status`.  Default for `operatingsystem` == `funtoo`.  Supported features: `enableable`, `refreshable`.
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/status`, `/sbin/start`, `/sbin/initctl`, `/sbin/stop`, `/sbin/restart`.  Default for `operatingsystem` == `ubuntu`.  Supported features: `enableable`, `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management on OS X.
    ...
    Required binaries: `/usr/bin/uuidgen`, `/usr/bin/dsimport`, `/usr/bin/dscacheutil`, `/usr/bin/dscl`, `/usr/bin/plutil`.  Default for `operatingsystem` == `darwin`.  Supported features: `manages_password_salt`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `rolemod`, `usermod`, `userdel`, `roleadd`, `passwd`, `useradd`, `roledel`.  Default for `osfamily` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Mon Mar 18 10:54:38 -0700 2013*
