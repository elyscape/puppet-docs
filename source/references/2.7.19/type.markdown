...
**This page is autogenerated; any changes will get overwritten** *(last generated on Mon Oct 15 11:53:41 -0700 2012)*
...
: The specific backend to use for this `service`
  ...
  : This provider manages jobs with `launchd`, which is the default service
    ...
    * disabled --- 'Disable' added to job plist file
    ...
    Required binaries: `/usr/bin/plutil`, `/bin/launchctl`, `/usr/bin/sw_vers`.  Default for `operatingsystem` == `darwin`.  Supported features: `enableable`, `refreshable`.
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/start`, `/sbin/status`, `/sbin/initctl`, `/sbin/stop`, `/sbin/restart`.  Default for `operatingsystem` == `ubuntu`.  Supported features: `enableable`, `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management for AIX.
    ...
    Required binaries: `/usr/sbin/lsgroup`, `/usr/sbin/lsuser`, `/usr/sbin/rmuser`, `/bin/chpasswd`, `/usr/bin/chuser`, `/usr/bin/mkuser`.  Default for `operatingsystem` == `aix`.  Supported features: `manages_aix_lam`, `manages_expiry`, `manages_homedir`, `manages_password_age`, `manages_passwords`.
  ...
  : User management for HP-UX. This provider uses the undocumented `-F`
    ...
    Required binaries: `/usr/sam/lbin/userdel.sam`, `/usr/sam/lbin/usermod.sam`, `/usr/sbin/useradd`.  Default for `operatingsystem` == `hp-ux`.  Supported features: `allows_duplicates`, `manages_homedir`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `rolemod`, `userdel`, `passwd`, `roleadd`, `usermod`, `useradd`, `roledel`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
  ...
  : User management via `useradd` and its ilk.  Note that you will need to
    ...
    Required binaries: `userdel`, `chage`, `usermod`, `useradd`.  Supported features: `allows_duplicates`, `manages_expiry`, `manages_homedir`, `system_users`.
...
: The specific backend to use for this `zone`
  ...
  : Provider for Solaris Zones.
    ...
    Required binaries: `/usr/sbin/zoneadm`, `/usr/sbin/zonecfg`.  Default for `operatingsystem` == `solaris`.
...
*This page autogenerated on Mon Oct 15 11:53:42 -0700 2012*
