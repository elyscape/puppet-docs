...
<p><strong>This page is autogenerated; any changes will get overwritten</strong> <em>(last generated on Thu Feb 24 17:23:07 -0800 2011)</em></p>
...
file.</p>
<p>The default checksum parameter, if checksums are enabled, is md5.  Valid values are <code>mtime</code>, <code>md5</code>, <code>timestamp</code>, <code>md5lite</code>, <code>time</code>.  Values can also match <code>/^\{md5|md5lite|timestamp|mtime|time\}/</code>.</p>
...
<p>Required binaries: <code>nireport</code>, <code>niutil</code>, <code>mount</code>, <code>umount</code>, <code>df</code>.    Default for <code>operatingsystem</code> == <code>darwin</code>.</p>
</blockquote>
</li>
...
<blockquote>
<p>Required binaries: <code>/usr/bin/sw_vers</code>, <code>/usr/bin/security</code>.    Default for <code>operatingsystem</code> == <code>darwin</code>.</p>
</blockquote>
</li>
</ul>
...
<p>The basic property that the resource should be in.  Valid values are <code>absent</code>, <code>purged</code>, <code>present</code>.</p>
...
'normal' system files.  Valid values are <code>latest</code>, <code>absent</code>, <code>purged</code>, <code>present</code> (also called <code>installed</code>).  Values can also match <code>/./</code>.</p>
...
libraries.  Required binaries: <code>/usr/sbin/pkg_add</code>, <code>/usr/sbin/pkg_delete</code>, <code>/usr/sbin/pkg_info</code>.      Supported features: <code>installable</code>, <code>uninstallable</code>.</p>
</dd>
</dl>
</li>
<li><dl>
...
<li><p><strong>openbsd</strong>: OpenBSD's form of <code>pkg_add</code> support.  Required binaries: <code>pkg_add</code>, <code>pkg_delete</code>, <code>pkg_info</code>.    Default for <code>operatingsystem</code> == <code>openbsd</code>.    Supported features: <code>installable</code>, <code>uninstallable</code>.</p>
</li>
...
<dd><p>the packages you're managing.  Required binaries: <code>/usr/sbin/pkgadd</code>, <code>/usr/sbin/pkgrm</code>, <code>/usr/bin/pkginfo</code>.    Default for <code>operatingsystem</code> == <code>solaris</code>.    Supported features: <code>installable</code>, <code>uninstallable</code>, <code>upgradeable</code>.</p>
</dd>
</dl>
</li>
<li><dl>
...
<li><p><strong>urpmi</strong>: Support via <code>urpmi</code>.  Required binaries: <code>urpmq</code>, <code>urpmi</code>, <code>rpm</code>.    Default for <code>operatingsystem</code> == <code>mandrivamandrake</code>.    Supported features: <code>installable</code>, <code>uninstallable</code>, <code>upgradeable</code>, <code>versionable</code>.</p>
</li>
...
via <code>update-rc.d</code>.</p>
<p>Required binaries: <code>/usr/sbin/update-rc.d</code>.    Default for <code>operatingsystem</code> == <code>debianubuntu</code>.    Supported features: <code>enableable</code>, <code>refreshable</code>.</p>
</blockquote>
</li>
...
<p>Required binaries: <code>/bin/launchctl</code>.    Default for <code>operatingsystem</code> == <code>darwin</code>.    Supported features: <code>enableable</code>, <code>refreshable</code>.</p>
</blockquote>
</li>
...
<p>Required binaries: <code>/usr/sbin/svcadm</code>, <code>/usr/bin/svcs</code>.    Default for <code>operatingsystem</code> == <code>solaris</code>.    Supported features: <code>enableable</code>, <code>refreshable</code>.</p>
</blockquote>
</li>
</ul>
...
<p>You must specify either the size or age of the file (or both) for
files to be tidied.</p>
...
into the directory looking for files to tidy.  Valid values are <code>true</code>, <code>false</code>, <code>inf</code>.  Values can also match <code>/^[0-9]+$/</code>.</p>
...
enable us to set a password.  Required binaries: <code>nireport</code>, <code>niutil</code>.      Supported features: <code>manages_passwords</code>.</p>
</dd>
</dl>
</li>
...
<li><p><strong>useradd</strong>: User management via <code>useradd</code> and its ilk.  Note that you will need to install the <code>Shadow Password</code> Ruby library often known as ruby-libshadow to manage user passwords.  Required binaries: <code>usermod</code>, <code>userdel</code>, <code>useradd</code>.      Supported features: <code>allows_duplicates</code>, <code>manages_homedir</code>.</p>
</li>
</ul>
...
Set this to 'absent' to remove it from the file completely  Valid values are <code>absent</code>.  Values can also match <code>/.*/</code>.</p>
...
values are '0', and '1'.
Set this to 'absent' to remove it from the file completely  Valid values are <code>absent</code>.  Values can also match <code>/(0|1)/</code>.</p>
...
Set this to 'absent' to remove it from the file completely  Valid values are <code>absent</code>.  Values can also match <code>/roundrobin|priority/</code>.</p>
...
<p>Set this to 'absent' to remove it from the file completely  Valid values are <code>absent</code>.  Values can also match <code>/(0|1)/</code>.</p>
...
Set this to 'absent' to remove it from the file completely  Valid values are <code>absent</code>.  Values can also match <code>/[0-9]+/</code>.</p>
...
Set this to 'absent' to remove it from the file completely  Valid values are <code>absent</code>.  Values can also match <code>/[1-9][0-9]?/</code>.</p>
...
<p>Manage zpools. Create and delete zpools. The provider WILL NOT SYNC, only report differences.
Supports vdevs with mirrors, raidz, logs and spares.</p>
...
<hr />
<p><em>This page autogenerated on Thu Feb 24 17:23:08 -0800 2011</em></p>
