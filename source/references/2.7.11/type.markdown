...
**This page is autogenerated; any changes will get overwritten** *(last generated on Fri Feb 24 14:59:27 -0800 2012)*
...
: The specific backend to use for this `package`
  ...
  : Support for SuSE `zypper` package manager. Found in SLES10sp2+ and SLES11
    ...
    Required binaries: `/usr/bin/zypper`, `rpm`.  Supported features: `installable`, `uninstallable`, `upgradeable`, `versionable`.
...
: The specific backend to use for this `service`
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/initctl`, `/sbin/start`, `/sbin/stop`, `/sbin/restart`, `/sbin/status`.  Supported features: `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management for AIX.
    ...
    Required binaries: `/usr/sbin/lsgroup`, `/usr/sbin/lsuser`, `/usr/bin/chuser`, `/usr/sbin/rmuser`, `/bin/chpasswd`, `/usr/bin/mkuser`.  Default for `operatingsystem` == `aix`.  Supported features: `manages_aix_lam`, `manages_expiry`, `manages_homedir`, `manages_password_age`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `roledel`, `rolemod`, `userdel`, `usermod`, `passwd`, `useradd`, `roleadd`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
...
*This page autogenerated on Fri Feb 24 14:59:28 -0800 2012*
