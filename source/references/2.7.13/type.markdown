...
**This page is autogenerated; any changes will get overwritten** *(last generated on Wed Apr 11 13:32:39 -0700 2012)*
...
: The specific backend to use for this `service`
  ...
  : Ubuntu service management with `upstart`.
    ...
    Required binaries: `/sbin/status`, `/sbin/start`, `/sbin/restart`, `/sbin/initctl`, `/sbin/stop`.  Supported features: `refreshable`.
...
: The specific backend to use for this `user`
  ...
  : User management for AIX.
    ...
    Required binaries: `/usr/sbin/lsgroup`, `/usr/sbin/lsuser`, `/bin/chpasswd`, `/usr/bin/chuser`, `/usr/sbin/rmuser`, `/usr/bin/mkuser`.  Default for `operatingsystem` == `aix`.  Supported features: `manages_aix_lam`, `manages_expiry`, `manages_homedir`, `manages_password_age`, `manages_passwords`.
  ...
  : User and role management on Solaris, via `useradd` and `roleadd`.
    ...
    Required binaries: `roledel`, `rolemod`, `passwd`, `userdel`, `usermod`, `roleadd`, `useradd`.  Default for `operatingsystem` == `solaris`.  Supported features: `allows_duplicates`, `manages_homedir`, `manages_password_age`, `manages_passwords`, `manages_solaris_rbac`.
  ...
  : User management via `useradd` and its ilk.  Note that you will need to
    ...
    Required binaries: `chage`, `userdel`, `usermod`, `useradd`.  Supported features: `allows_duplicates`, `manages_expiry`, `manages_homedir`, `system_users`.
...
*This page autogenerated on Wed Apr 11 13:32:39 -0700 2012*
