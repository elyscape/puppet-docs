...
: The specific backend for provider to use. You will
    ...
    * **freebsd**: The specific form of package management on FreeBSD.  This is an
        ...
        libraries.  Required binaries: `/usr/sbin/pkg_add`, `/usr/sbin/pkg_info`, `/usr/sbin/pkg_delete`.      Supported features: `installable`, `uninstallable`.
    ...
    * **portupgrade**: Support for FreeBSD's ports using the portupgrade ports management software.
        ...
        for the portupgrade port.  Required binaries: `/usr/local/sbin/portversion`, `/usr/local/sbin/pkg_deinstall`, `/usr/local/sbin/portinstall`, `/usr/sbin/pkg_info`, `/usr/local/sbin/portupgrade`.      Supported features: `installable`, `uninstallable`, `upgradeable`.
...
: The specific backend for provider to use. You will
    ...
    * **upstart**: Ubuntu service manager upstart.
       ...
       * http://upstart.ubuntu.com/
        Required binaries: `/sbin/restart`, `/sbin/start`, `/sbin/status`, `/sbin/initctl`, `/sbin/stop`.      Supported features: `refreshable`.
...
*This page autogenerated on Sat May 21 17:20:22 -0700 2011*
