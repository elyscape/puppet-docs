...
> **NOTE:** This page was generated from the Puppet source code on 2014-05-06 10:14:44 -0700
...
* Supported features: `install_options`, `installable`, `purgeable`, `uninstallable`, `upgradeable`, `versionable`.
...
<pre><code>user { 'resource title':
  ...
  <a href="#user-attribute-purge_ssh_keys">purge_ssh_keys</a>       =&gt; <em># Purge ssh keys authorized for the user if they...</em>
