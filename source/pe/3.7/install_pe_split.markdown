...
If you plan on managing more than 1000 nodes, follow these split install instructions and then refer to the [additional Puppet master installation documentation](./install_multimaster.html) for instructions on adding additional Puppet masters to your PE deployment.
